...
class TestVisitedPlaces(TestCase):
    ...
    def test_visited_contains_only_places_visited(self):
...
class TestVisitPlace(TestCase):
    ...
    def test_visit_place(self):
        visit_place_url = reverse('place_was_visited', args=(2, )) #tuple, hence , 
    ...
    def test_non_existent_place(self):
        ...
        response = self.client.post(visited_nonexistent_place_url, follow=True)
